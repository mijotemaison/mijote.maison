...
Secure Recipes GRETA 92 est le projet final d'une formation GRETA 92 cybersécurité. Il doit demontrer la capacite a construire une application web PHP/MySQL complete, lisible, documentee et securisee.
