...
TEXT,
        'points' => ['PHP natif structuré, sans framework lourd.', 'MySQL avec PDO et requêtes préparées.', 'Bootstrap local, sans CDN, pour rester compatible avec la CSP.', 'JavaScript vanilla pour les interactions.', 'Docker local disponible pour lancer PHP + MySQL sur localhost:1234.'],
        'files' => ['Dockerfile', 'docker-compose.yaml', 'package.json', 'public/assets/vendor/bootstrap', 'config/database.php'],
        'code' => [
            [
...
$this->renderPublic('Recettes', 'recipes', compact('recipes', 'ratingSummaries', 'query', 'category'));
PHP,
            ],
            [
