...
<div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    ...
    <a class="btn-primary" href="/admin/recettes/creer">Creer</a>
</div>
                    ...
                    <tr class="bg-slate-950/40" data-search="<?= e($recipe['title'] . ' ' . $recipe['slug'] . ' ' . ($recipe['category'] ?? '') . ' ' . ($recipe['status'] ?? '')) ?>">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex flex-wrap gap-2">
                                <a class="btn-secondary" href="/admin/recettes/<?= e($recipe['id']) ?>/apercu">Apercu</a>
                                <a class="btn-secondary" href="/admin/recettes/<?= e($recipe['id']) ?>/modifier">Modifier</a>
