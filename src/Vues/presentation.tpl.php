<section class="section-blue-soft presentation-section py-3">
        ...
        <div class="presentation-shell">
            <aside class="presentation-sidebar">
                <div>
                    ...
                    <h1 class="display-font fw-black text-ink mb-0">Présentation jury</h1>
                </div>

                <progress class="presentation-progress" value="1" max="<?= count($slides) ?>" data-progress></progress>
                ...
                <nav class="presentation-side-links" aria-label="Navigation présentation">
