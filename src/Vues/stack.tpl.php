...
$responsibilities = [
    ...
    ['Documentation', 'README, CODEX et rapport sécurité avec extraits réels du projet.'],
];
...
<section class="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
    <div class="grid gap-6 lg:grid-cols-[.9fr_1.1fr] lg:items-start">
        <div>
            ...
            <p class="mt-4 leading-8 text-stone-700">Le cours montre une architecture avec un point d’entrée unique, une réécriture d’URL via Apache et une séparation Controller / Model / Vue. Le projet suit cette logique sur le front-office public et le back-office admin.</p>
