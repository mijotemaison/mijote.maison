...
APACHE,
    ...
    [
        ...
        'points' => ['Accueil avec présentation du site.', 'Liste publique limitée aux recettes publiées.', 'Recherche serveur, filtres catégorie et pagination.', 'Notes étoiles et commentaires approuvés sur la page recette.'],
...
PHP,
        ...
        'test' => 'Vérification : /recettes affiche les étoiles, /recettes?q=chocolat renvoie Fondant, et /recette/{slug} permet notation + commentaire modéré.',
    ],
    [
        'kicker' => 'Back-office',
        ...
        'points' => ['Dashboard avec statistiques.', 'CRUD recettes avec upload image.', 'Catégorie et statut brouillon/publié/archivé.', 'Modération des commentaires lecteurs.'],
        'files' => ['admin/dashboard.php', 'admin/recipes/*', 'admin/comments/index.php', 'admin/admins/*'],
