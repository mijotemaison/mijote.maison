...
PHP,
    ...
    [
        ...
        'points' => ['Dashboard avec statistiques et journal sécurité.', 'CRUD recettes avec upload image.', 'Aperçu avant publication et duplication en brouillon.', 'Modération des commentaires lecteurs.'],
        'files' => ['admin/dashboard.php', 'admin/recipes/*', 'admin/comments/index.php', 'app/repositories/SecurityLogRepository.php'],
        'test' => 'Vérification : accès /admin/dashboard.php sans session redirige vers /connexion ; duplication crée un brouillon et écrit un log.',
    ],
    [
