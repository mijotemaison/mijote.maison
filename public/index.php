...
$recipeMeta = [
    'veloute-de-potimarron' => ['category' => 'entrees', 'label' => 'Entrée', 'time' => '35 min', 'level' => 'Très facile', 'tag' => 'Douceur automne'],
...
<section class="relative overflow-hidden bg-[#fff1dc]">
    <div class="mx-auto grid max-w-7xl gap-10 px-4 py-10 sm:px-6 lg:grid-cols-[.95fr_1.05fr] lg:items-center lg:px-8 lg:py-14">
        <div class="relative z-10">
            <span class="inline-flex rounded-full border border-orange-200 bg-white px-4 py-2 text-sm font-extrabold text-tomato shadow-sm">Cuisine familiale · Idées gourmandes</span>
            ...
            <p class="mt-5 max-w-2xl text-lg leading-8 text-stone-700">Mijoté Maison rassemble des idées gourmandes pour tous les jours : entrées fraîches, plats réconfortants et desserts à partager.</p>
...
<section id="recettes" class="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
    <div class="mb-8 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
            ...
            <p class="mt-2 max-w-2xl text-stone-600">Des cartes gourmandes, une lecture rapide et des idées faciles à refaire à la maison.</p>
        </div>
        <a class="text-sm font-extrabold text-herb hover:text-tomato" href="/login.php">Espace équipe</a>
    </div>
...
<section class="bg-[#fff1dc] py-14">
    <div class="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[.9fr_1.1fr] lg:items-center lg:px-8">
        ...
        <div>
            ...
            <p class="mt-4 text-lg leading-8 text-stone-700">Chaque recette est pensée pour être lisible, appétissante et pratique : une belle photo, une liste d’ingrédients claire et des étapes simples.</p>
