...
$stackItems = [
    ...
    ['MySQL', 'Stocke les administrateurs, les recettes et les tentatives de connexion.'],
...
$responsibilities = [
    ...
    ['Base de données', 'Tables admins, recipes et login_attempts importées depuis database.sql.'],
    ...
    <div class="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[.9fr_1.1fr] lg:items-center lg:px-8">
        <div>
            ...
            <div class="mt-7 flex flex-wrap gap-3">
                <a class="btn-primary" href="/presentation.php">Voir la présentation</a>
                <a class="btn-secondary" href="/recipes.php">Voir les recettes</a>
            </div>
        </div>
