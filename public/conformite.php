...
$criteria = [
    [
        ...
        'files' => ['public/index.php', 'src/Controller/*', 'src/Model/*', 'src/Vues/*', 'admin/*'],
        'code' => [
...
PHP,
        ...
        'explanation' => 'Cette partie correspond à la méthode du prof : une requête HTTP arrive sur un point d’entrée unique, puis le routeur choisit le contrôleur. Les pages admin restent dans `admin/` et sont protégées séparément avec `require_admin()`.',
    ],
    [
...
PHP,
    ...
    [
        ...
        'files' => ['admin/recipes/index.php', 'admin/recipes/create.php', 'admin/recipes/edit.php', 'admin/recipes/delete.php'],
        'code' => [
            'title' => 'Création recette avec validation, CSRF et upload',
            'file' => 'admin/recipes/create.php',
            'body' => <<<'PHP'
if (is_post()) {
    require_valid_csrf();
...
PHP,
    ...
    [
        ...
        'files' => ['admin/admins/index.php', 'admin/admins/create.php', 'admin/admins/edit.php', 'admin/admins/delete.php'],
        'code' => [
            'title' => 'Suppression encadrée des administrateurs',
            'file' => 'admin/admins/delete.php',
            'body' => <<<'PHP'
if (!is_post()) {
...
PHP,
    ...
    [
        ...
        'files' => ['app/security/auth.php', 'src/Controller/AuthController.php', 'admin/*'],
        'code' => [
...
PHP,
    ...
    [
        ...
        'files' => ['app/security/csrf.php', 'admin/recipes/create.php', 'admin/admins/delete.php'],
        'code' => [
